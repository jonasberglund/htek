...
#import "InfoLinksViewController.h"
#import "MenuViewController.h"

@interface InfoLinksViewController (){
    NSArray *info;
    NSArray *members;
    NSArray *links;
...
@implementation InfoLinksViewController
...
{
    static NSString *CellIdentifier = @"InfoLinksCell";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@", cell.detailTextLabel.text]];
